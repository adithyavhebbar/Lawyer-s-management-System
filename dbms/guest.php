...
<nav class="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" style="z-index:3;width:250px" id="mySidebar">
  ...
  <div class="w3-padding-64 w3-large w3-text-grey" style="font-weight:bold">
     ...
     <a href="#lawyers"> Lawyers</a><i class="fa fa-caret-down"></i></a>
    ...
    <a href="#cases">Cases </a><i class="fa fa-caret-down"></i>
    </a>
...
include('config.php');
	...
	echo"<table><tr><th>Reg no</th><th> Name</th><th>gender</th><th>dob</th><th>city</th><th>contact no</th><th>email_id</th><th>Preferred case type</th><th>designation</th><th>court name</th><th>place</th><th>since</th><th>rating</th><th>view</th><th>rate</th></tr>";
	for ($j = 0 ;$j < $rows ; ++$j)
	{
		$result->data_seek($j);
