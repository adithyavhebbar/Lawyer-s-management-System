...
include('config.php');
  ...
  echo "<form action='search2.php' method='POST'>
	...
	echo"<table><tr><th>Case_id</th><th>Case Title</th><th>case start date</th><th>case close date</th><th>case type</th><th>judgement</th><th>Result towards</th><th>Result towards</th><th>Result towards</th><th>Result towards</th><th>lawyer1</th><th>lawyer2</th><th>lawyer3</th><th>lawyer4</th><th>court</th><th>place</th><th>update</th><th>Delete</th></tr>";
	for ($j = 0 ;$j < $rows ; ++$j)
	{
		$result->data_seek($j);
		...
		echo "<form method='POST' action='upcase1.html'>";
