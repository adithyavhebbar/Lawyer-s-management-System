            ...
            <td class="col-lg-3">
                <nav class="nav flex-column bg-light col-lg-12">
                    ...
                    <div class="border mt-lg-3">
                        ...
                        <a class="col-lg-6 mt-lg-3 ml-lg-3 text-dark font-weight-bold" href="ongoing.php">Ongoing Cases</a><br>
                        <a class="col-lg-6 mt-lg-3 ml-lg-3 text-dark font-weight-bold" href="nol.php">Lawyers Enrolled</a><br>
                        <a class="col-lg-6 mt-lg-3 ml-lg-3 text-dark font-weight-bold" href="noc.php">Number of cases</a><br>
                        <a class="col-lg-6 mt-lg-3 ml-lg-3 text-dark font-weight-bold" href="nog.php">Number of guests</a><br>
                    </div>
                    <div class="mb-lg-3">
                    </div>
                </nav>
