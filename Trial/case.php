...
echo "<div class='tablehor mt-lg-5'>";
echo "<table class='table table-info table-responsive table-bordered mt-lg-5'><thead class='thead-dark'><tr><th>Case_id</th><th>Case Title</th><th>case start date</th><th>case close date</th><th>case type</th><th>judgement</th><th>lawyer1</th><th>lawyer2</th><th>lawyer3</th><th>lawyer4</th><th>court</th><th>place</th><th>update</th><th>Delete</th></tr></thead>";
for ($j = 0; $j < $rows; ++$j) {
	$result->data_seek($j);
	...
	echo " <td style='color:black;'>	<select name='update'>
				...
				</select> &emsp; <input  style='color:black;' type='submit' name='submit' class='btn btn-sm' value='Go'></td>";
	echo "</form>";
