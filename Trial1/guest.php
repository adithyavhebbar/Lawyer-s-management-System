...
include('config.php');
	...
	$query="select l.regno,l.name,l.gender,l.city,l.contact_no,l.email_id,l.pctype,d.designation,c.court_name,p.place_name,r.rating
	...
	echo "<div>";
	echo"<table><tr><th>Reg no</th><th> Name</th><th>gender</th><th>city</th><th>contact no</th><th>email_id</th><th>Preferred case type</th><th>designation</th><th>court name</th><th>place</th><th>rating</th><th>rate</th></tr>";
	for ($j = 0 ;$j < $rows ; ++$j)
	{
		$result->data_seek($j);
