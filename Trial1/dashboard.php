      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-6 mb-4">
          ...
          <div class="card-header text-center">
            ...
            <p class="blue lighten-4"><button type="submit" class="btn btn-xl rounded" id="sendMessageButton" style="background-color: black;color: white;" onclick="location.href='registercase'">Create</button> &nbsp; &nbsp; &nbsp; &nbsp; Register a case<br>
